...
var Client = function(config) {
  ...
  if (!config["token"]) {
    throw new Exception("You must provide your token available at: https://youraccount."+config["host"]+"/settings#api");
  }
  if (!config["room"]) {
    throw new Exception("You must provide the room to watch.");
  }
